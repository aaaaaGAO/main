...
class CANExcelRepository:
    ...
    def _load_sheet_cases(self, ws, excel_path: str, excel_name: str) -> list[CANTestCase]:
        ...
        表头/列识别完全复用 XML 侧逻辑：
        - 使用 generate_xml_from_can._find_testcase_header_row 在前 50 行内找到真正的表头
        - 使用 generate_xml_from_can._find_col_index_by_name_in_values / _find_case_type_column_index_in_values
