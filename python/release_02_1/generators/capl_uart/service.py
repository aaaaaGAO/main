    ...
    def run_legacy_pipeline(self) -> None:
        ...
        try:
            ...
            try:
                ...
                print("\n读取 IVIToMCU sheet...")
                ivi_to_mcu_messages = rt.read_uart_excel_data(input_excel, sheet_name="IVIToMCU")
                ...
                mcu_to_ivi_messages = rt.read_uart_excel_data(input_excel, sheet_name="MCUToIVI")
