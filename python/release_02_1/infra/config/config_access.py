...
class ConfigAccessor:
    """主配置与固定配置的读取入口（静态方法集合）。"""

    @staticmethod
    def read_main(config_path: str) -> configparser.ConfigParser:
    ...
    @staticmethod
    def read_main_if_exists(config_path: str) -> configparser.ConfigParser:
    ...
    @staticmethod
    def read_main_tolerant_duplicates(config_path: str) -> configparser.ConfigParser:
    ...
    @staticmethod
    def read_fixed(base_dir: str) -> dict[str, str]:
